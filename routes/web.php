...
Route::get('test', 'testApi@test');
Route::post('/saveResults', 'KetoController@saveResults');
Route::get('/getResults', 'KetoController@getResults');
...
Route::group(['middleware' => 'auth'] , function() {
    ...
    Route::get('/addRecipes', function() {
        // $category_name = '';
        $data = [
            'category_name' => 'addRecipes',
            'page_name' => 'addRecipes',
            'has_scrollspy' => 0,
            'scrollspy_offset' => '',
        ];
        // $pageName = 'analytics';
        return view('pages.addRecipe')->with($data);
    });
